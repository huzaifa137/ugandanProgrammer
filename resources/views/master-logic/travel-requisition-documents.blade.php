...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Travel Requisition Documents</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Travel Requisition Documents</li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
            ...
            <div class="panel panel-default tabs-style-4">
                <div class="panel-body tabs-menu-body">
                    <div class="tab-content">
                        <h3 class="heading text-primary">Travel Requisition Documents</h3>

                        <form id="myForm" action="{{ route('store-travel-requisition-document') }}" method="POST">
                            ...
                            <div class="formSep">
                                ...
                                <div class="row border">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <label for="">Enter Travel Requisition Document</label>
