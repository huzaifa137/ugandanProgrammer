...
@section('content')
						...
						<div class="row">
							...
							<div class="col-md-3">
								<h4 class="text-primary">User Roles</h4>
							...
							<div class="col-md-3">
								<h4 class="text-primary">User Divisions</h4>
								<div style="height:200px;overflow:auto;">
									<ul>
										{!! $user_division !!}
									</ul>
						...
						<!-- <div class="row">
							<div class="col-md-6">
								<h4 class="text-primary">My Team under User Role(s)</h4>
								<ul id="tree1">											
							...
							<div class="col-md-6">
								<h4 class="text-primary">My Team under Division(s)</h4>
								<ul id="treeview1">											
									<li><a href="#">Treeview6</a>
										<ul>
											<li>Company Maintenance</li>
