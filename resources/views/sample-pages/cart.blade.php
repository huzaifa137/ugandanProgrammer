            ...
            <div class="card">
                ...
                <div class="card-body ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#" class="remove_cart" data-toggle="tooltip" data-placement="top"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex w-200">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/products/6.jpg') }}" alt="img"
                                                    title="" class="w-7 h-7">
                                            </div>
                    ...
                    <div class=" float-right">
                        <a href="{{ url('/' . ($page = 'shop')) }}" class="btn btn-info mt-2"><i
                                class="fe fe-arrow-left"></i> Continue Shopping</a>
