            ...
            <div class="row">
                    ...
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/7.jpg') }}" alt="img"
                        ...
                        <div class="text-center border-top p-4">
                            <a href="{{ url('/' . ($page = 'shop-des')) }}" class="btn btn-light btn-svgs mt-1 mb-1"><svg
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/1.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/9.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/2.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/4.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/8.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card ">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/3.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/images/products/5.jpg') }}" alt="img"
                                    class="img-fluid w-100">
                            </div>
                            <div class="card-body px-0 ">
                                <div class="cardtitle">
