    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <form id="quizForm" action="{{ route('store.assignments') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 mb-0">
                                <div class="form-group">
                                    <label><strong>Instructions (optional) </strong></label>
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-clipboard"></i> Save Assignment
                            </button>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        form.on('submit', function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You are about to create this assignment.",
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    submitBtn.html('Creating assignment... <i class="fas fa-spinner fa-spin"></i>');
