										...
										<div class="e-panel card">
											<div class="card-body pb-2">
												<div class="row">
													...
													<div class="col mb-4">
														<h3 class="text-dark">Delegations to Me {{$pending_acceptance}} </h3>
													</div>
													<div class="col col-auto mb-4">
														<div class="form-group w-100">
																<div class="col mb-4 float-right">
																	<a href="{{ url('users/delegate') }}" class="btn btn-primary"><i class="fe fe-list"></i> My Delegations </a>
																</div>
														</div>
													</div>
												</div>
												@if(!count($delegations))
													<div><br><br/><br><br/><center>You do not have any delegation to you</center><br/><br/><br/></div>
												@endif
																...
																<div class="float-right ml-auto">
																	<div class="btn-group ml-3 mb-0">
																		...
																		<div class="dropdown-menu">
																			...
																			<a onclick="return confirm('Do you really want to Accept?')" class="dropdown-item" href="{{url('users/accept-delegation/'.$del->id) }}"><i class="fe fe-check mr-2"></i> Accept</a>
																		</div>
																	</div>
																</div>
																@endif
