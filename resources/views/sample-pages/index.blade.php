            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-12">
                            <img src="{{ URL::asset('assets/images/photos/award.png') }}" alt="img"
                                class="sales-img">
                ...
                <div class="card-body">
                    <div class="scrollbar h-400" id="scrollbar">
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets/images/orders/1.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets/images/orders/2.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets/images/orders/3.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets/images/orders/4.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets/images/orders/5.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="table-responsive">
                            <table class="table transaction-table mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/orders/9.jpg') }}" alt="media1">
                                            Modal Car</td>
                                        <td>#76273277</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/orders/12.jpg') }}" alt="media1">
                                            Watch</td>
                                        <td>#12323423</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/orders/14.jpg') }}" alt="media1"> New
                                            Modal shoe</td>
                                        <td>#12323423</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/orders/5.jpg') }}" alt="media1">
                                            Branded Shoes</td>
                                        <td>#26762768</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                            ...
                            <table class="table transaction-table mb-0">
                                <tbody>
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/1.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/4.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/5.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/2.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/10.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets/images/users/12.jpg') }}" alt="media1">
                                            <div class="mt-2">
